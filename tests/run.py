...
def seed_db():
    ...
    standards_data = [
        ...
        ('생활규정', '학습 공간에서 학습과 관계없는 행위게임드라마 시청 등을 하는 경우', 3, 0),
        ('생활규정', '기숙사 무단 출입 및 방조', 3, 0),
        ('생활규정', '사감의 정당한 지시 불이행 (비명시 항목)', 5, 0),
        ('생활규정', '기숙사 사감의 승인 없이 배달음식을 기숙사에 반입 및 섭취', 5, 0),
        ('생활규정', '무단 외출 (기숙사동에서 이탈)', 5, 0),
        ('생활규정', '상기 내용에 포함되지 않았으나 뚜렷이 지도할 내용', 5, 0),
        ('생활규정', '정당한 사유 없이 귀사하지 않음(무단 외박 포함)', 8, 0),
        ('생활규정', '사감에 대한 불손한 언행 및 태도', 10, 0),
        ('생활규정', '음주, 흡연, 절도 등 중요 위반 사항 확인시 영구 명령퇴사', 0, 0),

        ('생활규정', '기숙사 봉사활동 시간 참여', 0, 1),
        ('생활규정', '기숙사 내 분실물을 찾아주었을 때', 0, 1),
        ('생활규정', '기숙사 방 청결 상태 우수', 0, 1),
        ('생활규정', '몸이 불편한 학생의 기숙사 생활에 도움을 주었을 때', 0, 2),
        ('생활규정', '월간 기숙사 생활태도 우수 학생으로 선정된 경우', 0, 2),
        ('생활규정', '상기 내용에 포함되지 않았으나 뚜렷이 칭찬할 내용', 0, 2),
    ]
